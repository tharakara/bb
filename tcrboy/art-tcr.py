...
kk = LINETCR.LINE()
kk.login(token="EnjJZ9DwhO4Ze0slYhra.pSDK9W9GNKEW3ZO6AOJZcG.fNzBsTuH4P6X3pvp2owQkhLebqIh/ueCCJE0qCTibKI=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnGqNnaULpRwad4M2QJ8.HTrXFzvKdVbbhcMyeKLO/a.r/rI2zuTt6fHf2dg38/hYMTH4nuiOzVQRhY1sp7Y0pg=")
ks.loginResult()

kc = LINETCR.LINE()
kc.login(token="En7W0mtOX2AxU84a51U6.9OcWxuVDX5v++t5j5xdA5G.x9+bZK+8oYhVe4DwSNiot6L6+ZVWKSZRBS5RnkqJQyM=")
kc.loginResult()

ka = LINETCR.LINE()
ka.login(token="EnpWOD8yGewbC61I2cu0.vchZhTBvITJ1fFQoXrIeua.hfoWEB64fH8SR2TVceVbq00nyiX4JrHil0wjTexLb78=")
ka.loginResult()
...
admin = ["uaf5fee25d6ae8cc464c6531026ec40da","uf291388a1ed2cb1a0864b84a7b6106a6"]
...
admins = ["uaf5fee25d6ae8cc464c6531026ec40da","uf291388a1ed2cb1a0864b84a7b6106a6"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Owner http://line-tcr.py/ti/p/~khlongtoey450",
    "lang":"JP",
    "comment":"Auto like By.✨☬http://line.me/ti/p/~khlongtoey450☬",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
...
#----------------------------------------------------------
                ...
                cl.sendText(msg.to,"ƊƛƑƬƛƦ ƛƘƲƝ ƁƠƬ ԼƖƝЄ Ɣ.2 👇👇")
...
#-----------------------------------------------
                ...
                mi_d = Mids[:33]
                cl.createGroup("GŘØỮP ĆØV€Ř", mi_d)
